...
_Lưu ý: Khi dùng cách này, ST sẽ tự lo việc thông báo lên màn hình UI "AI đang dùng công cụ..." rất đẹp mắt._
...
1. Dùng **EventSource** làm _Đôi mắt và Lỗ tai_ để đón sự kiện.
2. Dùng **Slash Commands** làm _Tay chân_ để thao túng ST.
3. Dùng **ToolManager** làm _Bộ công cụ_ để mở rộng khả năng (Tìm web, đọc file, chạy code).
4. Dùng **DOM jQuery** làm _Băng dính_ để chắp vá các tính năng thiếu hụt API.
