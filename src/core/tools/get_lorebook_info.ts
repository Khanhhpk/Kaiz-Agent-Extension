        ...
        parameters: {
            ...
            properties: {
                mode: {
                    ...
                    description:
                        'Chế độ lấy dữ liệu. LƯU Ý: Chế độ "char_full" và "all_full" tốn rất nhiều token, CHỈ NÊN DÙNG khi đã thử các cách khác (summary, search, simulate, by_uid) mà vẫn không tìm thấy thông tin người dùng cần.',
                },
                book_name: {
                    type: 'string',
